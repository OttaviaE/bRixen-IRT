...
Per intepretare la $-$\emph{2loglikelihood}, va calcolata la differenza tra la \emph{likelihood} di due modelli nested moltiplicata per $-2$ ($-2$\emph{LogLikelihood}) e la differenza tra i gradi di libertà dei due modelli nested
