...
I soggetto vengono appaiati in funzione del loro livello di tratto latente. \high{Ci sono delle differenze nella perfomance su un item}?
...
Se così non è $\rightarrow$ \high{\scshape{Differential Item Functioning}} (DIF)
...
La DIF uniforme viene valutata sui parametri di diffcoltà, mentre la DIF non uniforme viene valutata sui parametri di discriminatività
